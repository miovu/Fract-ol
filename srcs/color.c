...
/*   Updated: 2025/03/19 17:42:53 by miovu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	palette_2(t_fractal *fractal)
{
	...
	if (fractal->color.red > 255)
		...
		fractal->color.blue = 255;
	return (fractal->color.blue << 16 | fractal->color.red << 8 | fractal->color.green);
}
...
int	palette_3(t_fractal *fractal)
{
	...
	if (fractal->color.red > 255)
		...
		fractal->color.blue = 255;
	return (fractal->color.green << 16 | fractal->color.blue << 8 | fractal->color.red);
}
